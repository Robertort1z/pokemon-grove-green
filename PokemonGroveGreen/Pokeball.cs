...
namespace PokemonGroveGreen
{
    ...
    public class Pokeball : Item
    {
                ...
                using (MySqlCommand cmd = new MySqlCommand(query, conn))
                {
                    ...
                    using (MySqlDataReader reader = cmd.ExecuteReader())
                    {
                        if (reader.Read())
                        {
                            ...
                            this.captureRate = reader.GetInt32("capture_rate");
                        }
                    }
                }
            }
        ...
        public void Use(Random r, Pokémon enemy)
        {
            enemy.Capture(r, captureRate);
            this.ThrowAway();
        }
    }
}
